...
import {fetchAllUserData, fetchUserData, userDelete, userUpdate} from '../../api/authService';
...
export default function AdminDashboard({loading,error,...props}){
    ...
    const handleEdit = (id) => {
        setId(id);
        history(`/dashboard/adminDashboard/edit/${id}`);
    };
                                    ...
                                    <ul className="navbar-nav ml-auto">
                                        ...
                                        <li className="nav-item dropdown no-arrow">
                                            <a className="nav-link dropdown-toggle" href="#" id="userDropdown"
                                               ...
                                               data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                <span
                                                    className="mr-2 d-none d-lg-inline text-gray-600 small">{data.name} {data.surname}</span>
                                                {/*FIX IMAGE*/}
                                                    ...
                                                    <tbody>
                                                        {allUsers.map((tempEmployee) => (
                                                            <tr key={tempEmployee.id}>
                                                                ...
                                                                <td>
                                                                    <button  className="btn btn-danger btn-sm" onClick={() => handleDelete(tempEmployee.id)} >
                                                                        Delete
                                                                    </button>
                                                                </td>
                                                            </tr>
