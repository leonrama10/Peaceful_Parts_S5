    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests((requests) -> requests
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/auth/addNewNote","/api/auth/fetchOldNotesHistory","/api/auth/fetchOldNotes","/api/auth/selectWorkDays").hasRole("THERAPIST")
